...
st.sidebar.image("Images/Stock_title.png", width=250,
...
# Stock Price Prediction Section Ends Here
    ...
    st.markdown('<p class="big-font">StockStream is a web application that allows users to visualize Stock Performance Comparison, Real-Time Stock Prices and Stock Price Prediction. This application is developed using Streamlit. Streamlit is an open source app framework in Python language. It helps users to create web apps for Data Science and Machine Learning in a short time. This Project is developed by Vaibhav Sharma. You can find more about the developer on their GitHub Profiles shared below.<br>Hope you are able to employ this application well and get your desired output.<br> Cheers!</p>', unsafe_allow_html=True)
    st.subheader('Vaibhav Sharma [![Repo](https://badgen.net/badge/icon/GitHub?icon=github&label)](https://github.com/VaibHavShaRma3) ')
